...
public class LightShot extends Shot {
    ...
    public void drawShot(GraphicsContext gc) {
        gc.drawImage(Loader.getInstance().currentShotImages.get(0), this.position.getX() - Constants.SHOT_SIZE[0]/2.0, this.position.getY() - Constants.SHOT_SIZE[0]/2.0, Constants.SHOT_SIZE[0], Constants.SHOT_SIZE[0]);
    }
}
